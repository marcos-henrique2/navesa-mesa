...
- [ ] **As três origens de "abaixo do custo"** verificadas nos dois lugares — alerta de abertura e badge do `/repasses` (C16). Carro girado deliberadamente **não** mostra vermelho; carro com gasto tardio **mostra**
